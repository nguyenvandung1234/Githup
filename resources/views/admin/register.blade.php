            ...
            <div class="auth_form-form">
                <div class="auth_form-container">
                    <div class="auth-login">
                        <div class="auth-item">
                            <h2 class="auth_heading">Form register</h2>
                        </div>
                        <div class="auth-item">
                    ...
                    <div class="auth_form">
                        <div class="auth_form-grup">
                            <input type="text" class="auth_form-input" placeholder="Name" name="name">
                            @error('name')
                            <small>{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        <div class="auth_form-grup">
                            <input type="password" class="auth_form-input" placeholder="confirm_password"
                    ...
                    <div class="auth_form-control">
                        <button type="submit" class="btn-btn btn-sm btn-login">Register</button>
                        <a href="{{route('admin.login')}}" class="btn-btn btn-sm btn-register">Login</a>
                    </div>
                </div>
            </div>
        </div>
