...
<form action="{{route('home.comment',$product->id)}}" method="POST" role="form">
    @csrf
    <div class="form-group">
        <textarea name="comment" class="form-control" rows="1" placeholder="Nội dung bình luận"></textarea>
    </div>
...
<div class="media">
    <a class="pull-left" href="#">
        <img width="50" class="media-image"
            src="https://banner2.cleanpng.com/20191121/bhp/transparent-avatar-icon-user-icon-user-image-with-black-backgr-5dd6cb5dd7c4b2.3306979215743578538838.jpg"
            alt="Image">
    </a>
    <div class="media-body">
        <h4 class="media-heading">{{$comm->customer->name}}</h4>
        <p class="media-comment">{{$comm->comment}}</p>
        <p>{{$comm->created_at->format('d/m/y')}}</p>
        <p>
            <a href="#" class=" btn-edit"><i class="fa-solid fa-pencil"></i></a>
