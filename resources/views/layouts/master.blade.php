                ...
                <div class="container">
                    ...
                    <div class="header-right">
                        <ul class="top-links mega-menu show-arrow d-none d-lg-inline-block mt-0 mb-0">
                            <li class="item-menu narrow"><a href="">Cart</a></li>
                            <li class="item-menu"><a class="login" href="{{route('home.login')}}">Login</a></li>
                            <li class="item-menu"><a class="login" href="{{route('home.logout')}}">Logout</a></li>
                        </ul>
            ...
            <div class="container">
                <div class="row m-b-3">
                    <div class="home-slider-container col-lg-9 offset-lg-3">
                        <div class="home-slider owl-carousel owl-carousel-lazy owl-theme slide-animate"
                            data-owl-options="{
                            'nav': false
                        }">
                            <div class="home-slide banner">
                                ...
                                <div class="banner-layer slide-1 text-xl-right banner-layer-middle">
                                    ...
                                    <h2 class="text-xl-right text-uppercase sub-title appear-animate"
                                        data-animation-delay="300" data-animation-name="fadeInUpShorter">Shoes Sale</h2>
                                    <div class="row">
                                        ...
                                        <div class="col-auto col-md-6 content-right appear-animate"
                                            data-animation-delay="700" data-animation-name="fadeInRightShorter">
                                            <h4
                                                class="d-inline-block text-left text-uppercase line-height-1 d-inline-block">
                                                Starting At</h4>
                            ...
                            <div class="home-slide banner">
                                ...
                                <div class="banner-layer slide-2 text-right banner-layer-middle">
                                    <div>
                                        ...
                                        <div class="pt-1">
                                            <a href="demo9-shop.html"
                                                class="btn btn-modern btn-lg btn-light appear-animate"
                ...
                <div class="m-b-1"></div>
                <!-- margin -->
                <div class="banner newsletter-banner bg-img appear-animate"
                    style="background-image: url(../assets/images/demoes/demo9/banners/banner.jpg)">
                    <div class="banner-content col-md-9 col-xl-6 col-lg-8 col-11 p-l-5 pr-0">
                        ...
                        <h5 class="text-center text-body font-weight-normal m-b-3 p-x-4">Get all the latest information
